...
*   [AsuroLib Online Dokumentation][26] 
...
###  PollSwitch Aufrufe stört die Encoder Abfrage im Interrupt Betrieb
...
*   void Sound(uint16\_t freq, uint16\_t duration\_msec, uint8\_t amplitude) Einführung einer Sound Funktion (Autor stochri) 
...
switches=FALSE;Â  // für eine neuen Aufruf von Startswitch() 
